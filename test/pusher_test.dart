...
import 'package:pusher_http_dart/src/options.dart' show defaultHttpsPort, defaultHttpPort;
import 'package:pusher_http_dart/src/validation.dart' show channelNameMaxLength;
...
void main() {
  ...
  group('Pusher', () {
    ...
    setUp(() {
      pusher = new Pusher(pusherAppId, pusherAppKey, pusherAppSecret, new PusherOptions(cluster: 'ap1'));
    });
